...
userSchema.plugin(uniqueValidator); // Appel du plugin 'mongoose-unique-validator' pour ne pas avoir deux utilisateurs avec le même Email, permet de bien interpréter les erreurs générées par MongoDb
